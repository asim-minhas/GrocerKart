...
public class Potatoes extends GroceryItem {
    public Potatoes(double x, double y) {
        super("Potatoes", 4, x, y);
        try  {
        	 String currentDirectory = System.getProperty("user.dir");

 	        // Specify the relative directory path
 	        String relativeDirectoryPath = "\\resources\\pngs\\potatoes.png";
